...
function Body() {
  ...
  this.text = function() {
    ...
    if (this._bodyBlob) {
      console.log('fetch text _bodyBlob...');
      return readBlobAsText(this._bodyBlob)
    } else if (this._bodyArrayBuffer) {
      console.log('fetch text _bodyArrayBuffer...');
      return Promise.resolve(readArrayBufferAsText(this._bodyArrayBuffer))
    } else if (this._bodyFormData) {
      console.log('fetch text _bodyFormData...');
      throw new Error('could not read FormData body as text')
    } else {
      console.log('fetch text _bodyText...');
      console.log(this._bodyText);
...
function fetch(input, init) {
  return new Promise(function(resolve, reject) {
    ...
    if (request.signal && request.signal.aborted) {
		console.log('fetch.................request.signal.aborted');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EosApi", function() { return EosApi; });
const EosApi = __webpack_require__(4) // Or EosApi = require('./src')



if (typeof window !== 'undefined' && typeof window.EosApi === 'undefined') {
...
var apiGen = __webpack_require__(8);
var processArgs = __webpack_require__(1);
...
//# sourceMappingURL=eos.cocos.js.map